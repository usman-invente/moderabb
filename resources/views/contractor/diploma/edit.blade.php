...
<form method="POST" action="{{route('cupdate_diploma',$data->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
<div class="card">
<div class="card-header">
<h3 class="page-title float-left">edit package</h3>
<div class="float-right">
<a href="{{route('ccourses')}}" class="btn btn-success">view courses</a>
</div>
</div>
