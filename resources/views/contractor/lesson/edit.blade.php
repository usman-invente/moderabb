...
<form method="POST" action="{{ route('cupdate_lessons',$data->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
    {{--  <input id="lesson_id" name="model_id" type="hidden" value="0">  --}}

<div class="card">
<div class="card-header">
<h3 class="page-title float-left mb-0">edit lesson</h3>
<div class="float-right">
<a href="{{ route('clessons') }}" class="btn btn-success">view lessons</a>
</div>
</div>
...
<div class="col-12 col-lg-6 form-group">
    ...
    <input class="form-control" placeholder="Url will be created automatically" value="{{ $data->url }}"  name="url" type="text" id="slug">
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control " placeholder="Enter a short description of the lesson" name="short_text" cols="50" rows="10" id="short_text">{{ $data->title }} </textarea>
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control summernote" placeholder="" name="full_text" cols="50" rows="10" id="outputs">{{ $data->title }} </textarea>
</div>
</div>
<div class="row">
<div class="col-12 form-group">
...
<div class="col-md-12 form-group">
    ...
    <input class="form-control mt-3 d-none" placeholder="Enter video data" value="{{ $data->video_file }}"  id="video_file" name="video_file" type="file">
