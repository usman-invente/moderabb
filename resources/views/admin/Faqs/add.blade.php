...
<form method="POST" action="{{ route('create_faqs')}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
    {{--  <input id="lesson_id" name="model_id" type="hidden" value="0">  --}}

<div class="card">
<div class="card-header">
<h3 class="page-title float-left mb-0">create Faq</h3>
...
<div class="row">
    <div class="col-12 form-group">
        ...
        <input class="form-control" placeholder="question" required=""  name="question" type="text" id="question">
    </div>
    </div>
<div class="row">
<div class="col-12 form-group">
    <label for="short_text" class="control-label">answer</label>
    <textarea class="form-control summernote" placeholder="Enter a short answer of the test" name="answer" cols="50" rows="10" id="answer"></textarea>
