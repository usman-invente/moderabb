...
<div class="card-header">
    ...
    <div class="float-right">
        <a data-toggle="" id="createCatBtn" data-target="#createCat" href="{{ route('advisoryboards') }}" class="btn btn-success collapsed" aria-expanded="false">View</a>
...
<div class="row" id="createCat" style="">
    <div class="col-12">
    <form method="POST" action="{{ route('update_advisoryboards',$data->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
        @csrf    
        <div class="row">
            ...
            <div class="col-lg-4 col-12 form-group mb-0">
                ...
                <input class="form-control" placeholder="position" value="{{ $data->position }}" name="position" type="text" id="position">

            </div>
            <div class="col-lg-4 col-12 form-group mb-0">
                <label for="link" class="control-label">link</label>
                <input class="form-control" placeholder="link" name="web_link" value="{{ $data->web_link }}" type="text" id="link">
            </div>
            ...
            <div class="col-lg-4 col-12 form-group mb-0">
                ...
                <img src="{{asset('upload/advisory/'.$data->logo)}}" height="80" width="180" style="margin-top: 10px">
            </div>
