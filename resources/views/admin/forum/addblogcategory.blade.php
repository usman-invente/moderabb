...
<main class="main">
	<div class="container-fluid" style="padding-top: 30px">
		<div class="animated fadeIn">
			...
			<form class="form-horizontal" method="POST" action="{{ route('create_sliders') }}" id="slider-create" enctype="multipart/form-data">
                 @csrf
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" name="name" id="name" placeholder="name" maxlength="191" autofocus=""> </div>
						</div>
						<div class="row form-group">
						...
						<div class="row form-group">
							...
							<div class="col-md-10">
								<label class="switch switch-sm switch-3d switch-primary">
									<input class="switch-input" type="checkbox" name="overlay" id="overlay" value="1"><span class="switch-label"></span><span class="switch-handle"></span></label>
						...
						<div class="row form-group">
							...
							<div class="col-md-10">
								<input class="form-control" type="text" name="hero_text" id="hero_text" placeholder="slide text"> </div>
						</div>
						<div class="row form-group">
							<label class="col-md-2 form-control-label" for="sub_text">sub-text</label>
							<div class="col-md-10">
								<input class="form-control" type="text" name="sub_text" id="sub_text" placeholder="sub-text"> </div>
						</div>
						<div class="row form-group">
