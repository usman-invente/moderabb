...
<form class="form-horizontal" method="POST" action="{{ route('update_teacher', $data->id) }}" enctype="multipart/form-data">
    @csrf
<div class="card">
<div class="card-header">
<h3 class="page-title d-inline">Edit Coach</h3>
<div class="float-right">
    <a href="{{ route('teacher') }}" class="btn btn-success">view coaches</a>
</div>
</div>
<div class="card-body">
<div class="row">
