...
@section('content')
    ...
    <div class="container-fluid" style="padding-top: 30px">
        <div class="animated fadeIn">
            ...
            <form method="POST" action="{{ route('create_courses') }}" accept-charset="UTF-8"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2 d-flex form-group flex-column">
                                OR <a target="_blank" class="btn btn-primary mt-auto"
                                    href="{{ route('add_teacher') }}">add trainers</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-10 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 d-flex form-group flex-column">
                                OR <a target="_blank" class="btn btn-primary mt-auto"
                                    href="{{ route('add_categories') }}">Add Categories</a>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <div class="checkbox d-inline mr-3">
                                    ...
                                    <label for="flag" class="checkbox control-label font-weight-bold">Enable or
                                        disable
                                        course purchase
                                    </label>
                                </div>
