...
<form method="POST" action="{{route('create_courses')}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
<div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-10 form-group">
                                <label for="teachers" class="control-label">trainers *</label>
                                <select class="form-control select2 js-example-placeholder-multiple select2bs4" required
                                    name="teachers">
                                    @foreach ($trainer as $tran)
                                        <option value="{{ $tran->id }}">{{ $tran->name }}</option>
                                    @endforeach
                            ...
                            <div class="col-2 d-flex form-group flex-column">
                                OR <a target="_blank" class="btn btn-primary mt-auto" href="">add trainers</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-10 form-group">
                                ...
                                <select class="form-control select2 js-example-placeholder-single select2bs4" required=""
                                    id="e3tmad_id" name="eccbody_id" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-10 form-group">
                                <label for="category_id" class="control-label">Category *</label>
                                <select class="form-control select2 js-example-placeholder-single select2bs4" required=""
                                    id="category_id" name="category_id" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="col-2 d-flex form-group flex-column">
                                OR <a target="_blank" class="btn btn-primary mt-auto" href="">Add Categories</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-lg-4 form-group">
                                <label for="bag_type" class="control-label">bag type *</label>
                                <select class="form-control select2 js-example-placeholder-single select2bs4" required=""
                                    id="bag_type" name="bag_type" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="col-12 col-lg-4 form-group">
                                <label for="title" class="control-label">title *</label>
                                <input class="form-control" placeholder="title" required="" name="title" type="text"
                                    id="title">
                            </div>
                            <div class="col-12 col-lg-4 form-group">
                                <label for="slug" class="control-label">Url</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                <label for="description" class="control-label">description</label>
                                <textarea class="form-control " placeholder="description" name="description" cols="50"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 form-group">
                                <label for="price" class="control-label">price (in $)</label>
                                <input class="form-control" placeholder="price" pattern="[0-9]" name="price" type="number"
                                    id="price">
                            </div>
                            <div class="col-12 col-lg-8 form-group">
                                <label for="course_image" class="control-label">course image</label>
                                <input class="form-control" accept="image/jpeg,image/gif,image/png" name="course_image"
                                    type="file" id="course_image">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 form-group">
                                <label for="price_certificate" class="control-label">Certificate Price (in $)</label>
                                <input class="form-control" placeholder="Certificate Price" pattern="[0-9]"
                                    name="price_certificate" type="number" id="price_certificate">
                            </div>
                            <div class="col-12 col-lg-8 form-group">
                                <label for="certificate" class="control-label">certificate copy</label>
                                <input class="form-control" accept="image/jpeg,image/gif,image/png" name="certificate"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4  form-group">
                                <label for="start_date" class="control-label" style="width: 100%;">start date
                                    (yyyy-mm-dd)</label>
                                <input class="form-control hasDatepicker" placeholder="start date (Ex . 2019-01-01)"
                                    autocomplete="off" id="start_date" name="start_date" type="date">

                            </div>
                            <div class="col-12 col-lg-4  form-group">
                                <label for="end_date" class="control-label" style="width: 100%;">end date</label>
                                <input class="form-control date hasDatepicker" placeholder="end date (Ex . 2019-01-01)"
                                    autocomplete="off" name="end_date" type="date" id="end_date">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-4 form-group">
                                <label for="voltage" class="control-label">required voltage</label>
                                <input class="form-control" placeholder="required voltage" name="voltage" type="text"
                                    id="voltage">
                            </div>
                            <div class="col-12 col-lg-4 form-group">
                                <label for="duration" class="control-label">duration</label>
                                <input class="form-control" placeholder="duration" name="duration" type="text"
                                    id="duration">
                            </div>
                            <div class="col-12 col-lg-4 form-group">
                                <label for="recording_url" class="control-label">Synchronous course link</label>
                                <input class="form-control" placeholder="Synchronous course link" name="recording_url"
                                    type="text" id="recording_url">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <div class="checkbox d-inline mr-3">
                                    ...
                                    <label for="flag" class="checkbox control-label font-weight-bold">Enable or disable
                                        course purchase
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <textarea class="form-control summernote" placeholder="" name="goals" cols="50" rows="40"
                                    id="goals"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <textarea class="form-control summernote" placeholder="" name="requirements" cols="50"
                                    rows="10" id="requirements"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 form-group">
                                <label for="outputs" class="control-label">Course Outputs</label>
                                <textarea class="form-control summernote" placeholder="" name="outputs" cols="50" rows="10"
                                    id="outputs"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <textarea class="form-control summernote" placeholder="" name="target_group" cols="50"
                                    rows="10" id="target_group"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 form-group">
                                <label for="sponsor_name" class="control-label">This course is sponsored</label>
                                <textarea class="form-control summernote" placeholder="" name="sponsor_name" cols="50"
                                    rows="10" id="sponsor_name"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input class="form-control mt-3 d-none" placeholder="Enter video data" id="video"
                                    name="video" type="text">


                                <input class="form-control mt-3 d-none" placeholder="Enter video data" id="video_file"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <textarea class="form-control" placeholder="Tags" name="meta_keywords" cols="50" rows="10"
