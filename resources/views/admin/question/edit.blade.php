...
<form method="POST" action="{{ route('update_question',$quest->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
<div class="card">
<div class="card-header">
<h3 class="page-title float-left mb-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Edit question</font></font></h3>
<div class="float-right">
<a href="{{ route('questions') }}" class="btn btn-success"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">view questions</font></font></a>
</div>
</div>
<div class="card-body">
<div class="row">
<div class="col-12 form-group">
    ...
    <textarea class="form-control " placeholder="" required="" name="question" cols="50" rows="10" id="question">{{ $quest->question }}</textarea>
...
<div class="col-12 form-group">
    ...
    <img src="{{asset('upload/qimage/'.$quest->question_image)}}" height="80" width="180" style="margin-top: 10px">
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <input class="form-control" placeholder="" required="" name="score" value="{{ $quest->score }}" type="number" value="1" id="score">
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="option_text_1" cols="50" id="option_text_1">{{ $quest->option_text_1 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="explanation_1" cols="50" id="explanation_1">{{ $quest->explanation_1 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <input name="correct_1" type="checkbox" value="1" id="correct_1" {{ ($quest->correct_1 == 1 ? ' checked' : '') }}>
    <p class="help-block"></p>
            </div>
</div>
</div>
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="option_text_2" cols="50" id="option_text_2">{{ $quest->option_text_2 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="explanation_2" cols="50" id="explanation_2">{{ $quest->explanation_2 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <input name="correct_2" type="checkbox" value="1" id="correct_2" {{ ($quest->correct_2 == 1 ? ' checked' : '') }}>
    <p class="help-block"></p>
                    </div>
</div>
</div>
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="option_text_3" cols="50" id="option_text_3">{{ $quest->option_text_3 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="explanation_3" cols="50" id="explanation_3">{{ $quest->explanation_3 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <input name="correct_3" type="checkbox" value="1" id="correct_3" {{ ($quest->correct_3 == 1 ? ' checked' : '') }}>
    <p class="help-block"></p>
                    </div>
</div>
</div>
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="option_text_4" cols="50" id="option_text_4">{{ $quest->option_text_4 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <textarea class="form-control " rows="3" name="explanation_4" cols="50" id="explanation_4">{{ $quest->explanation_4 }}</textarea>
    <p class="help-block"></p>
                    </div>
</div>
<div class="row">
<div class="col-12 form-group">
    ...
    <input name="correct_4" type="checkbox" value="1" id="correct_4" {{ ($quest->correct_4 == 1 ? ' checked' : '') }}>
    <p class="help-block"></p>
                    </div>
</div>
</div>
