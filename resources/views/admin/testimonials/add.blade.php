...
<form method="POST" action="{{ route('create_testimonials')}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
    {{--  <input id="lesson_id" name="model_id" type="hidden" value="0">  --}}

<div class="card">
<div class="card-header">
<h3 class="page-title float-left mb-0">Create a Recommendation</h3>
...
<div class="col-12 form-group">
    ...
    <textarea class="form-control" placeholder="Enter a short content" name="content" cols="50" rows="10" id="content"></textarea>
</div>
</div>
<div class="row">
    <div class="col-12 form-group">
        <label for="course_id" class="control-label">image</label>
        <input class="form-control" placeholder="image" required=""  name="image" type="file" id="image">
    </div>
    </div>
<div class="row">
