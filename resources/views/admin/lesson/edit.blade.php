...
<form method="POST" action="{{ route('update_lessons',$data->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
...
<a href="{{ route('lessons') }}" class="btn btn-success">view lessons</a>
</div>
</div>
