...
<form method="POST" action="{{route('create_diploma')}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
<div class="card">
<div class="card-header">
<h3 class="page-title float-left">create course</h3>
<div class="float-right">
<a href="{{route('diploma')}}" class="btn btn-success">view courses</a>
</div>
</div>
...
<div class="card-body">
    ...
    <div class="col-2 d-flex form-group flex-column">
        OR <a target="_blank" class="btn btn-primary mt-auto" href="{{ route('add_courses') }}">add Courses</a>
    </div>
</div>
