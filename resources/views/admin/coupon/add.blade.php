...
<div class="container-fluid" style="padding-top: 30px">
 ...
 <form class="form-horizontal" method="POST" action="{{ route('create_coupon') }}" id="coupons-create" enctype="multipart/form-data">
    @csrf
...
<div class="col-md-10">
    <textarea class="form-control" name="description" id="description" placeholder="description" autofocus=""></textarea>
...
<div class="col-md-10">
    <input class="form-control" type="text" name="code" id="code" placeholder="Ex: MyShopping50">
...
<div class="col-md-10">
    <select class="form-control" name="type" id="type">
        <option value="1">discount rate (in %)</option>
...
<div class="col-md-10">
    <input class="form-control" type="number" name="advert_perce" id="advert_perce" placeholder="advertiser percentage">
</div><!--col-->
</div>
...
<div class="col-md-10">
    <input class="form-control" type="text" name="advert_name" id="advert_name" placeholder="Advertiser Name">
</div><!--col-->
</div>
<div class="row form-group">
...
<div class="col-md-10">
<input class="form-control date hasDatepicker"  id="expires_at" placeholder="yyyy-mm-dd | Ex . 2019-01-01" autocomplete="off" name="expires_at" type="date">
</div>
</div>
...
<div class="col-md-10">
    <input class="form-control" type="number" name="min_price" id="min_price" placeholder="Minimum Order Price">
...
<div class="col-md-10">
    <input class="form-control" type="number" name="per_user_limit" id="per_user_limit" placeholder="per user limit">
