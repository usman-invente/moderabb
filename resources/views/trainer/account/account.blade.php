...
<form class="form-horizontal" method="POST" action="{{ route('tupdate_account', $data->id) }}" enctype="multipart/form-data">
    @csrf
<div class="card">
...
<div class="row">
    <div class="col-12">
        ...
        <div class="form-group row justify-content-center">
            <div class="col-4">
                {{--  <a class="btn btn-danger" href="{{ route('tteacher') }}">Cancel</a>  --}}
