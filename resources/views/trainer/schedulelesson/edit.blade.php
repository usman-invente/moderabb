...
<form method="POST" action="{{ route('tupdate_live_lesson_slots', $data->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
...
<a href="{{ route('tlive_lesson_slots') }}" class="btn btn-success">view scheduling
</a>
</div>
</div>
