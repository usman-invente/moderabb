...
<form method="POST" action="{{route('tcreate_courses')}}" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf
<div class="card">
<div class="card-header">
<h3 class="page-title float-left">create course</h3>
<div class="float-right">
<a href="{{route('tcourses')}}" class="btn btn-success">view courses</a>
</div>
</div>
